...
public class proServices {
	 ...
	 * 
	 * ***/
	public PageModel<Product> getPageModelpro1(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException{
	 ...
	 * 
	 * */
	public PageModel<Product> getPageModelproByname(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException{
