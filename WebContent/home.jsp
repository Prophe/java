...
<div id="main">
			...
			<div id="nav">
				...
				<ul>  
			        ...
			        <li><a href="#">商品</a>
			        	<ul>  
			                <li><a href='Propage.do' title="goods。jsp" onclick="handover(this)">商品列表</a></li>  
							...
							<ul id="nav_dot">
						      <li>
						          ...
						          <div class="list-item none" id="shangpina" style="height: 0;"  >
						            <a  title="goods"  onclick="goods()" >商品列表</a>
								...
								<li>
						          ...
						          <div class="list-item none" id="dingdana" style="height: 0;">
						            <a  onclick="order(1)">待支付订单</a>
						            <a  onclick="order(2)">已付款订单</a>
						            <a  onclick="order(3)">已发货订单</a>
						            <a  onclick="order(4)">已完成订单</a>
						          </div>
						       
								<li>
						          <h4  class="M7" title="memberlist.jsp" onclick="handover(this)"  ><span></span>会员管理</h4>
